...
Block.prototype.makeHills = function (position){
    this.geometry.vertices.forEach(function (v, i){
        if(i%11!=0 && i%11!=10 && Math.floor(i/11)!=0 && Math.floor(i/11)!=10){
            v.y += Math.floor(Math.random()*50 -25);
        } 
    });
    ...
    this.geometry.vertices.forEach(function (v, i){
        ...
        v.y += Math.sin(z/rK1)*rK3;
        v.y += Math.sin(x/rK2)*rK3;
        v.y += Math.sin((x+z)/rK12)*rK4;

        v.y += Math.sin(z/(rK1*10))*rK3*5;
        v.y += Math.sin(x/(rK2*10))*rK3*5;
        v.y += Math.sin((x+z)/(rK12*10))*rK4*5;

        //v.y += Math.cos(z/(6000))*1000;
        //v.y += Math.cos(x/(6000))*1000;
        //r= Math.sqrt(x*x + z*z);
        //v.y += Math.cos(r/(6000))*1000;
        v.y += Math.sin(z/rK1)*rK3;
        v.y += Math.sin(x/rK2)*rK3;
    ...
    this.geometry.vertices.forEach(function (v, i){
        ...
        if(r<d){
            v.y = equalAvg(i, this.geometry.vertices)*(r/d) + v.y*(1-(r/d));     
        }else{
            v.y = equalAvg(i, this.geometry.vertices);
        }
    });
    ...
    this.geometry.vertices.forEach(function (v, i){
        ...
        if(x+z<3000 && Math.sqrt(x*x +z*z)<1000){
            v.y = 1500;
        }else if(x+z<3000 && Math.sqrt(x*x +z *z)<2000){

            percent = angle/(Math.PI * 2);
            
            v.y = percent*1500;
            //v.y+=  100 *(Math.sqrt(x*x +z *z)-1000)/2000;
        }else if(x>1 && Math.abs(z-1500*Math.cos((x-1000)/1000))<1000){
            v.y=0;       
        }

        a=2000;
        v.y += 8*a*a*a/(r*r/5 + 4*a*a);
        
        /*
        if(Math.abs( angle*500 - (r)%(2*Math.PI*500))<500){
            v.y=0;       
